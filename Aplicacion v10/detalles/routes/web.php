...
Route::middleware(['auth', 'admin'])
    ...
    ->group(function () {
        ...
        |--------------------------------------------------------------------------
        */
        Route::get('products/{product}/personalization', [ProductPersonalizationController::class, 'index'])
            ->name('products.personalization.index');

        Route::post('products/{product}/personalization/fields', [ProductPersonalizationController::class, 'storeField'])
            ->name('products.personalization.fields.store');

        Route::patch('personalization/fields/{field}/toggle', [ProductPersonalizationController::class, 'toggleField'])
            ->name('personalization.fields.toggle');

        Route::delete('personalization/fields/{field}', [ProductPersonalizationController::class, 'destroyField'])
            ->name('personalization.fields.destroy');

        Route::post('personalization/fields/{field}/options', [ProductPersonalizationController::class, 'storeOption'])
            ->name('personalization.options.store');

        Route::delete('personalization/options/{option}', [ProductPersonalizationController::class, 'destroyOption'])
            ->name('personalization.options.destroy');
