    ...
    <div
        ...
        <form class="space-y-6" method="POST" action="{{ route('login') }}">
            ...
            <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
                ...
                <li>
                    <h1 class="ms-4 text-xl font-bold text-gray-900 dark:text-white">Inicio de sesión para clientes</h1>
                </li>
            </ul>
            <p class="text-xl text-gray-400 dark:text-white">Si tiene una cuenta, inicie sesión con su dirección de correo electrónico.</p>
            <div>
                <label for="email"
            ...
            <div class="flex items-start">
                <div class="flex items-start">
                    ...
                    <label for="remember"
                        class="ms-2 text-xl font-medium text-gray-900 dark:text-gray-300">Recordarme</label>
                </div>
                <a href="{{ route('password.request') }}" class="ms-auto text-xl text-indigo-500 hover:underline dark:text-blue-500">¿Has olvidado tu contraseña?</a>
            </div>
            <button type="submit"
                class="text-white bg-pink-600 hover:bg-indigo-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl px-24 py-3.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Iniciar sesión</button>
            <div class="text-xl font-medium text-gray-600 dark:text-gray-300">
                ¿Eres nuevo cliente? <a href="{{ route('register') }}" class="text-indigo-500 hover:underline dark:text-white-500">Crea tu
                    cuenta</a>
            </div>
        </form>
    </div>
