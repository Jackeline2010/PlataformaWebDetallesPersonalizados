            ...
            <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                        Los presentes Términos y Condiciones regulan la relación contractual entre la Tienda y el Cliente derivada de la compra realizada a través del sitio web.
            Al realizar un pedido, el Cliente declara haber leído y aceptado expresamente los presentes Términos y Condiciones.
                    </p>
                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <button data-modal-hide="default-modal" type="button" class="text-white bg-pink-600 hover:bg-indigo-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cerrar</button>
                </div>
            </div>
        </div>
    </div>
