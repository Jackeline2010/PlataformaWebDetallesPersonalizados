            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="{{ route('admin') }}" class="flex ms-4 md:me-24">
                        ...
                        <span
                            class="text-white self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SandyDecor</span>
                    </a>
                </div>
            ...
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="#"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Catálogo</span>
