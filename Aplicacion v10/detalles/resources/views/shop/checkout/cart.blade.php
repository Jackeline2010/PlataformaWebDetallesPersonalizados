      ...
      <div class="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              <a href="#" class="shrink-0 md:order-1">
                <img class="h-20 w-20 dark:hidden" src="{{ asset('assets/products/producto_001.jpg') }}" alt="imac image" />
                <img class="hidden h-20 w-20 dark:block" src="{{ asset('assets/products/producto_001.jpg') }}" alt="imac image" />
              </a>
              ...
              <div class="flex items-center justify-between md:order-3 md:justify-end">
                ...
                <div class="text-end md:order-4 md:w-32">
                  <p class="text-base font-bold text-gray-900 dark:text-white">$30.00</p>
                </div>
              </div>

              <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">Ramo de Flores con Oso de Peluche</a>
        ...
        <div class="space-y-6">
          <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              <a href="#" class="shrink-0 md:order-1">
                <img class="h-20 w-20 dark:hidden" src="{{ asset('assets/products/producto_008.jpg') }}" alt="imac image" />
                <img class="hidden h-20 w-20 dark:block" src="{{ asset('assets/products/producto_008.jpg') }}" alt="imac image" />
              </a>
              ...
              <div class="flex items-center justify-between md:order-3 md:justify-end">
                ...
                <div class="text-end md:order-4 md:w-32">
                  <p class="text-base font-bold text-gray-900 dark:text-white">$75.00</p>
                </div>
              </div>

              <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">Ramo de Rosas Multicolores + Botella de Vino + Chocolates + Oso Teddy</a>
        ...
        <div class="space-y-6">
          <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
            <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
              <a href="#" class="shrink-0 md:order-1">
                <img class="h-20 w-20 dark:hidden" src="{{ asset('assets/products/producto_003.webp') }}" alt="imac image" />
                <img class="hidden h-20 w-20 dark:block" src="{{ asset('assets/products/producto_003.webp') }}" alt="imac image" />
              </a>
              ...
              <div class="flex items-center justify-between md:order-3 md:justify-end">
                ...
                <div class="text-end md:order-4 md:w-32">
                  <p class="text-base font-bold text-gray-900 dark:text-white">$18.00</p>
                </div>
              </div>

              <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">Ramo de Girasoles y Rosas - Estilo Nocturno</a>
          ...
          <div class="space-y-4">
            <div class="space-y-2">
              ...
              <dl class="flex items-center justify-between gap-4">
                ...
                <dd class="text-base font-medium text-green-600">-$3.00</dd>
              </dl>
            ...
            <dl class="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              ...
              <dd class="text-base font-bold text-gray-900 dark:text-white">$124.50</dd>
            </dl>
          </div>

          <a href="{{ route('order') }}" class="flex w-full items-center justify-center rounded-lg bg-pink-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Finalizar compra</a>
