  ...
  <form action="#" class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    <div class="mx-auto max-w-3xl">
      ...
      <div class="mt-6 space-y-4 border-b border-t border-gray-200 py-8 dark:border-gray-700 sm:mt-8">
        ...
        <dl>
          <dd class="mt-1 text-base font-normal text-gray-500 dark:text-gray-400">Ramona Cordero 4-75 y José Astudillo, Catamayo, Loja. Celular: 098 733 7085.</dd>
          <dd class="mt-1 text-base font-normal text-gray-500 dark:text-gray-400">Casa esquinera de 2 pisos diagonal al parque central de Catamayo.</dd>
        </dl>

        <button type="button" data-modal-target="billingInformationModal" data-modal-toggle="billingInformationModal" class="text-base font-medium text-primary-700 hover:underline dark:text-primary-500">Editar</button>
      </div>
      ...
      <div class="mt-6 sm:mt-8">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                ...
                <td class="whitespace-nowrap py-4 md:w-[384px]">
                  <div class="flex items-center gap-4">
                    <a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
                      <img class="h-auto w-full max-h-full dark:hidden" src="{{ asset('assets/products/producto_001.jpg') }}" alt="imac image" />
                      <img class="hidden h-auto w-full max-h-full dark:block" src="{{ asset('assets/products/producto_001.jpg') }}" alt="imac image" />
                    </a>
              ...
              <tr>
                <td class="whitespace-nowrap py-4 md:w-[384px]">
                  <div class="flex items-center gap-4">
                    <a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
                      <img class="h-auto w-full max-h-full dark:hidden" src="{{ asset('assets/products/producto_008.jpg') }}" alt="imac image" />
                      <img class="hidden h-auto w-full max-h-full dark:block" src="{{ asset('assets/products/producto_008.jpg') }}" alt="imac image" />
                    </a>
                    <a href="#" class="hover:underline"> Ramo de Rosas Multicolores + Botella de Vino + Chocolates + Oso Teddy </a>
                  </div>
                </td>
              ...
              <tr>
                <td class="whitespace-nowrap py-4 md:w-[384px]">
                  <div class="flex items-center gap-4">
                    <a href="#" class="flex items-center aspect-square w-10 h-10 shrink-0">
                      <img class="h-auto w-full max-h-full dark:hidden" src="{{ asset('assets/products/producto_003.webp') }}" alt="imac image" />
                      <img class="hidden h-auto w-full max-h-full dark:block" src="{{ asset('assets/products/producto_003.webp') }}" alt="imac image" />
                    </a>
                    <a href="#" class="hover:underline">Ramo de Girasoles y Rosas - Estilo Nocturno </a>
                  </div>
                </td>
        ...
        <div class="mt-4 space-y-6">
          ...
          <div class="flex items-start sm:items-center">
            ...
            <label for="terms-checkbox-2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Estoy de acuerdo con los <a href="{{ route('terms') }}" title="" class="text-indigo-700 underline hover:no-underline dark:text-primary-500">Terminos y Condiciones</a> del servicio de SandyDecor</label>
          </div>

          <div class="gap-4 sm:flex sm:items-center">
            <button type="button" class="w-full rounded-lg  border border-gray-200 bg-white px-5  py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Seguir comprando</button>

            <button type="submit" class="mt-4 flex w-full items-center justify-center rounded-lg bg-pink-600  px-5 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-primary-300  dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 sm:mt-0">Confirmar la Orden</button>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 mb-5">
          <div class="sm:col-span-2">
            <div class="mb-2 flex items-center gap-1">
              <label for="saved-address-modal" class="block text-sm font-medium text-gray-900 dark:text-white"> Dirección de Entrega </label>
          ...
          <div>
            <div class="mb-2 flex items-center gap-2">
              <label for="select_country_input_billing_modal" class="block text-sm font-medium text-gray-900 dark:text-white"> Provincia </label>
            </div>
          ...
          <div>
            <div class="mb-2 flex items-center gap-2">
              <label for="select_city_input_billing_modal" class="block text-sm font-medium text-gray-900 dark:text-white"> Ciudad </label>
            </div>
          ...
          <div class="sm:col-span-2">
            <label for="address_billing_modal" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Indicaciones o Referencias</label>
            <textarea id="address_billing_modal" rows="4" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500" placeholder="Ingrese las referencias de entrega (lugares cercanos, caractísticas del lugar, etc) "></textarea>
          </div>

        </div>
        <div class="border-t border-gray-200 pt-4 dark:border-gray-700 md:pt-5">
          <button type="submit" class="me-2 inline-flex items-center rounded-lg bg-pink-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-pindigo-700 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Guardar Información</button>
