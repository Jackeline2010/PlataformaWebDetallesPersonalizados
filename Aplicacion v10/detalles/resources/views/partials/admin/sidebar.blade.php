                ...
                <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.shipments') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Envíos</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.transactions') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Transacciones</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="dropdown-customers" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="{{ route('admin.reviews') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Comentarios</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="dropdown-reports" class="hidden py-2 space-y-2">
                    <li>
                        <a href="{{ route('admin.customersreport') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Clientes</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.productsreport') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Productos</a>
                    </li>
                    <li>
