            ...
            <tbody>
                <tr
                    ...
                    <th scope="row"
                        ...
                        <img class="w-10 h-10 rounded-full" src="{{ asset('assets/users/profile-picture-1.jpg') }}"
                            alt="Jese image">
                        <div class="ps-3">
                            <div class="text-base font-semibold">Jackeline Cordova</div>
                            <div class="font-normal text-gray-500">jcordova@utpl.edu.ec</div>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        admin
                ...
                <tr
                    ...
                    <th scope="row"
                        ...
                        <img class="w-10 h-10 rounded-full" src="{{ asset('assets/users/profile-picture-2.jpg') }}"
                            alt="Jese image">
                        <div class="ps-3">
                            <div class="text-base font-semibold">Juan Pablo Montoya</div>
                            <div class="font-normal text-gray-500">jpmontoya@utpl.edu.ec</div>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        jmontoya
                ...
                <tr
                    ...
                    <th scope="row"
                        class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="{{ asset('assets/users/profile-picture-3.jpg') }}"
                            alt="Jese image">
                        <div class="ps-3">
                            <div class="text-base font-semibold">Fernando Cabrera</div>
                            <div class="font-normal text-gray-500">fcabrera@utpl.edu.ec</div>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        fcabrera
                ...
                <tr
                    ...
                    <th scope="row"
                        class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="{{ asset('assets/users/profile-picture-4.jpg') }}"
                            alt="Jese image">
                        <div class="ps-3">
                            <div class="text-base font-semibold">Alexander Ulloa</div>
                            <div class="font-normal text-gray-500">aulloa@utpl.edu.ec</div>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        aulloa
                ...
                <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th scope="row"
                        class="flex items-center px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="{{ asset('assets/users/profile-picture-5.jpg') }}"
                            alt="Jese image">
                        <div class="ps-3">
                            <div class="text-base font-semibold">Byron Oyervide</div>
                            <div class="font-normal text-gray-500">boyervide@utpl.edu.ec</div>
                        </div>
                    </th>
                    <td class="px-6 py-4">
                        boyervide
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                ...
                <form class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="email" name="email" id="email"
                                    class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="ejemplo@pruebas.com" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="department" id="department"
                                    class="shadow-xs bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Código usuario" required="">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                                <label for="role"
                    ...
                    <div
                        ...
                        <button type="submit"
                            class="text-white bg-pink-600 hover:bg-indigo-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Guardar
                            Cambios</button>
                    </div>
                </form>
            </div>
