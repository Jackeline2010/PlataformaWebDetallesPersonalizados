    ...
    <div class="flex items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">
                Controla el stock disponible de tus productos.
            </p>
        </div>
    </div>

    <form method="GET" action="{{ route('admin.inventory.index') }}" class="bg-white rounded-2xl border border-pink-100 shadow-sm p-4">
                        ...
                        <td class="px-4 py-3">
                            ...
                            >
                                ...
                                <input
                                    type="text"
                                    name="sku"
                                    value="{{ old('sku', $extra->sku) }}"
                                    placeholder="EXT-001"
                                    class="w-32 rounded-xl border border-pink-100 px-3 py-2"
                                >
                        </td>
